...
public interface NodeListVocabulary {
	public static final String TOTALDEMAND = "totaldemand";
	public static final String ROUTECOST = "routecost";
	public static final String INTLIST = "intList";
	public static final String NODELISTNAME = "nodelistname";
